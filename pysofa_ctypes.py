...
# iauAb - aberration + gravitational potential of the Sun
_sofa.iauAb.argtypes = [ndpointer(shape=(1,3), dtype=float), #pnat[3]
                                       ndpointer(shape=(1,3), dtype=float), #v[3]
                                       c_double, #s
                                       c_double, #bm1
                                       ndpointer(shape=(1,3), dtype=float)] #ppr[3]
def Ab(pnat, v, s, bm1):
    ppr = asmatrix(zeros(shape=(1,3), dtype=float))
    _sofa.iauAb(pnat, v, s, bm1, ppr)
    return ppr
